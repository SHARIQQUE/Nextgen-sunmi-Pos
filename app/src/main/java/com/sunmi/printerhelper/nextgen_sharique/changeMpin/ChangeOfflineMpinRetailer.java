...
public class ChangeOfflineMpinRetailer extends AppCompatActivity implements View.OnClickListener, InterHttpServerResponse {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            if (languageToUse.trim().length() == 0) {
                ...
                languageToUse = "ar";
                LocalSetLanguage.LocalSet(languageToUse, ChangeOfflineMpinRetailer.this);
            }
            else
            {
                LocalSetLanguage.LocalSet(languageToUse, ChangeOfflineMpinRetailer.this);
            ...
            setContentView(R.layout.change_offline_mpin_ret);
        ...
        {
            Toast.makeText(ChangeOfflineMpinRetailer.this,e.toString(),Toast.LENGTH_LONG).show();
            e.printStackTrace();
        }
    ...
    protected void successResponse()
    {
        ...
        dialog = new Dialog(ChangeOfflineMpinRetailer.this);
        ...
        dialogbutton1.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                ChangeOfflineMpinRetailer.this.finish();
        ...
        switch (view.getId()) {
            ...
            case R.id.imageButton1:
                ...
                if (validation_Details()) {
                    MyApplication.saveString("offlinePinString",et_confirmPin.getText().toString().trim(), ChangeOfflineMpinRetailer.this);
...
//                break;
    ...
    {
        String offlinePinString = MyApplication.getSaveString("offlinePinString", ChangeOfflineMpinRetailer.this);
        ...
        if(oldPinStr.isEmpty()) {
            ...
            Toast.makeText(ChangeOfflineMpinRetailer.this,getString(R.string.enter_old_5_digit_offline_pin), Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(ChangeOfflineMpinRetailer.this,getString(R.string.enter_new_5_digit_new_offline_pin), Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(ChangeOfflineMpinRetailer.this,getString(R.string.confirm_5_digit_new_offline_pin), Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(ChangeOfflineMpinRetailer.this,getString(R.string.new_coinfirm_should_be_same), Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(ChangeOfflineMpinRetailer.this,getString(R.string.old_offline_pin_is_not_correct_please_enter_correct_offline_old_pin), Toast.LENGTH_SHORT).show();
...
/*        {
        ...
        try {
            ...
            jsonObject_request.put("source",MyApplication.getSaveString("mobileNoString", ChangeOfflineMpinRetailer.this));
            ...
            new VollyRequestResponse(ChangeOfflineMpinRetailer.this, ChangeOfflineMpinRetailer.this, requestNo, base_url+login_ret_changeMpin_apinname, json_main.toString());
    ...
    private void showAlertDialog(String msg, final int requestId) {
        AlertDialog.Builder builder = new AlertDialog.Builder(ChangeOfflineMpinRetailer.this);
