...
public class OnlineRetRecycleViewPage extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            if (languageToUse.trim().length() == 0) {
                ...
                languageToUse = "ar";
                LocalSetLanguage.LocalSet(languageToUse, OnlineRetRecycleViewPage.this);
            }
            else
            {
                LocalSetLanguage.LocalSet(languageToUse, OnlineRetRecycleViewPage.this);
            ...
            setContentView(R.layout.online_recycleview_list_ret);
            ...
            String ONLINE_RET_API= MyApplication.getSaveString("ONLINE_PINSALE_RET_API", OnlineRetRecycleViewPage.this);
            JSONObject jsonObject = new JSONObject(ONLINE_RET_API);
            ...
            recycler_view.setLayoutManager(new LinearLayoutManager(OnlineRetRecycleViewPage.this));

            OnlineListRetAdapter recyclerViewAdapter = new OnlineListRetAdapter(OnlineRetRecycleViewPage.this,arrayList_OnlineListModal);
        ...
        {
            Toast.makeText(OnlineRetRecycleViewPage.this,e.toString(),Toast.LENGTH_LONG).show();
            e.printStackTrace();
        }
