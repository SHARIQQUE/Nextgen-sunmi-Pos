...
public class OrderPinOfflineReceiptPage extends AppCompatActivity implements View.OnClickListener{
    ...
    ArrayList<OrderPinModalOfflineReceiptPage> arrayList_OrderPinModalReceiptPage;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            if (languageToUse.trim().length() == 0) {
                ...
                languageToUse = "ar";
                LocalSetLanguage.LocalSet(languageToUse, OrderPinOfflineReceiptPage.this);
            }
            else
            {
                LocalSetLanguage.LocalSet(languageToUse, OrderPinOfflineReceiptPage.this);
           ...
           ServiceRepository serviceRepository = new ServiceRepository(OrderPinOfflineReceiptPage.this);
          ...
          //  serviceRepository.deleteAllBullkDownload();
            ...
            setContentView(R.layout.orderpin_offline_reciptpage);
            ...
            arrayList_OrderPinModalReceiptPage = new ArrayList<OrderPinModalOfflineReceiptPage>();
            arrayList_OrderPinModalReceiptPage.clear();




            String orderpin_receiptpage_api= MyApplication.getSaveString("ORDERPIN_RECEIPTPAGE_API", OrderPinOfflineReceiptPage.this);
            ...
            for(int i=0;i<jsonArray_records.length();i++) {
                ...
                */
                ...
                for(int j=0;j<jsonArray_r.length();j++) {
                    ...
                    OrderPinModalOfflineReceiptPage  orderPinModalReceiptPage = new OrderPinModalOfflineReceiptPage();
            ...
            recycler_view.setLayoutManager(new LinearLayoutManager(OrderPinOfflineReceiptPage.this));

            OrderPinAdapterOfflineReceiptPage recyclerViewAdapter = new OrderPinAdapterOfflineReceiptPage(OrderPinOfflineReceiptPage.this,arrayList_OrderPinModalReceiptPage);
        ...
        {
            Toast.makeText(OrderPinOfflineReceiptPage.this,e.toString(),Toast.LENGTH_LONG).show();
            e.printStackTrace();
        }
